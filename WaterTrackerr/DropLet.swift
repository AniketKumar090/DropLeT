...
struct AIChatView: View {
   ...
   let responses: [String] = [
        "Drinking water helps maintain hydration, which is essential for overall health.",
        "Water supports digestion by helping break down food and absorb nutrients.",
        "Staying hydrated improves skin health, making it look more radiant and youthful.",
        "Water boosts energy levels by preventing dehydration, which can cause fatigue.",
        "Drinking water aids in weight loss by increasing satiety and reducing calorie intake.",
        "Water helps flush out toxins from the body through urine and sweat.",
        "Proper hydration improves cognitive function and concentration.",
        "Water lubricates joints, reducing the risk of joint pain and arthritis.",
        "Drinking water regulates body temperature, especially during exercise.",
        "Water prevents headaches and migraines, which are often caused by dehydration.",
        "Staying hydrated improves physical performance during workouts.",
        "Water supports kidney function by helping filter waste from the blood.",
        "Drinking water can improve mood and reduce stress levels.",
        "Water helps maintain blood pressure by keeping blood volume stable.",
        "Hydration is crucial for maintaining electrolyte balance in the body.",
        "Water reduces the risk of urinary tract infections by flushing out bacteria.",
        "Drinking water can prevent constipation by keeping the digestive system active.",
        "Water helps transport nutrients and oxygen to cells throughout the body.",
        "Staying hydrated can reduce the risk of kidney stones.",
        "Water improves circulation, ensuring organs receive adequate oxygen.",
        "Drinking water can help reduce acne and improve skin clarity.",
        "Water supports the immune system by keeping mucous membranes moist.",
        "Hydration can reduce the risk of muscle cramps and spasms.",
        "Water helps maintain a healthy metabolism, aiding in weight management."
    ]
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text(viewModel.displayedText) // Display the text being typed out
                .font(.system(size: 16, weight: .semibold, design: .monospaced))
                .padding()
                .frame(maxWidth: .infinity, alignment: .leading)
            
            Button("Ask About Water Benefits") {
                Task {
                    await askAI()
                }
            }
    ...
    private func askAI() async {
        ...
        fullResponse = responses[currentResponseIndex]
        ...
        await MainActor.run {
            startTypingEffect()
            currentResponseIndex = (currentResponseIndex + 1) % responses.count // Cycle through responses
        }
    }
...
#Preview {
    AIChatView(viewModel: DrinkViewModel())
}
//import SwiftUI
//import Charts
//import Foundation
